        ...
        switch ( strtoupper( $method ) ) {
            ...
            case "POST":
                ...
                return [
                    ...
                    'key'       => 'bail|exclude_unless:parent_id,false|required|between:2,32|unique:App\Models\Config,title',
            ...
            case "PUT":
                ...
                return [
                    ...
                    'key'       => 'bail|exclude_unless:parent_id,false|required|between:2,32|unique:App\Models\Config,title,' . $config_id,
                    'value'     => 'bail|exclude_unless:key,false|required|between:2,32',
                    'type'      => 'bail|exclude_unless:type,true|in:' . join( ",", ConfigTypeEnum::getAllKey() ),
                    'status'    => 'bail|integer|in:' . join( ",", StatusEnum::getAllKey() ),
                    'sort'      => 'bail|between:1,255',
